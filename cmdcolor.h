...
namespace cmdcolor {
	enum color {
		...
		B_BLACK, B_BLUE, B_GREEN, B_AQUA, B_RED, B_PURPLE, B_YELLOW, B_WHITE, B_GRAY, B_LIGHTBLUE, B_LIGHTGREEN, B_LIGHTAQUA, B_LIGHTRED, B_LIGHTPURPLE, B_LIGHTYELLOW, B_LIGHTWHITE, DEFAULT = 1000
	};
